...
import com.srm.rta.service.HelpService;
...
@RestController
public class HelpController extends CommonController<HelpVO> {
	...
	@ResponseBody
	public ResponseEntity<JSONResponse> getHelpVoList(HttpServletRequest request,@RequestBody HelpVO helpRequest) {
		...
		try {
			...
			List<HelpVO> helpVo = helpService.getHelpVoList(helpRequest,authDetailsVo);
			...
			jsonResponse.setSuccesObject(helpVo);
